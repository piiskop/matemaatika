...
tasks <- list(
  ...
  list(
    goal = 3,
    level = 3,
    task = "$15,08+103,92=\\blank{999}$."
  ),
  list(
    goal = 4,
    level = 3,
    task = "$12,37-8,054=\\blank{999}.$"
  ),
  list(
    goal = 5,
    level = 3,
    task = "$0,35 \\times 20,4 = \\blank{999}.$"
  ),
  list(
    goal = 6,
    level = 3,
    task = "$8,5:0,1=\\blank{85}.$"
  ),
  list(
    goal = 7,
    level = 3,
  ...
  list(
    goal = 30,
    level = 3,
    task = "$\\frac{1}{y}-\\frac{2}{1-y}=\\frac{8}{y^2-y}.$\\leavevmode\\
    $y=\\blank{9}$."
  ),
  list(
    goal = 31,
